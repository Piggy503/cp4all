...
| Not_very_encouraging_encouragement_bot | Encourage people | Add some comments that could make it a little more, but not too encouraging, if not its name will not be accurate | https://github.com/Piggy503/Not_very_encouraging_encouragement_bot | Natalie Tan | 1E | 
